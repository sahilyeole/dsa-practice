...
// ! Added try and finally block to avoid resource leak (memory leak) of in ... try block will be run and if it is completed then finally block which will close the in scanner variable
